    ...
    <main className="col-span-10 row-span-11 w-full h-full p-10 flex flex-col">
      ...
      <form className="flex flex-col w-full h-full mt-20 gap-y-8">
        <div className="flex gap-x-4 md:w-1/2 w-full justify-between pr-30">
          ...
          <input type="email" className="border-2 border-solid border-black" />
        </div>
        <div className="flex gap-x-4 md:w-1/2 w-full justify-between pr-30">
        ...
        <div className="flex justify-center items-center w-full mt-auto mb-10 gap-x-10">
          <button
            type="submit"
            className="flex items-center justify-center gap-x-2 w-1/4 border-2 border-solid border-[#003C5D] rounded-3xl py-2 bg-[#FF5F5F] hover:bg-[#f44c4c] duration-300 hover:cursor-pointer mb-5"
          >
            <RiDeleteBin6Line type="submit" size={20} className="mr-2" />
          ...
          {isUser && (
            <Link
              to={`/user/settings`}
              type="button"
              className="flex items-center justify-center w-1/4 border-2 border-solid border-[#003C5D] rounded-3xl py-2 bg-white hover:bg-gray-300 duration-300 hover:cursor-pointer mb-5"
            >
